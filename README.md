...
<p align="center">
  <img src="images/アプリ概要.png" alt="アプリ概要" width="250">
</p>
...
<p align="center">
  <img src="images/GraphRAG_vs_Standard_RAG_Demo_UI.png" alt="全体構成" width="450">
</p>
...
- [工場の製造ライン監視と保全支援を題材にしたサンプルテキスト群](./data)を検索対象の文章として、「不良率上昇の原因と復旧策を、設備、症状、担当者の関係が分かるように説明してください。」と質問した際のRAGとGraphRAGの回答例を示します。
